                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            if (checkData.status == 1) {
                                ...
                                if((checkData.list.get(0).type).equals("1"))
                                {
                                    ...
                                    txt_test_no_cart.setText("Include "+packagedata.list.get(0).packageTestList.size()+" test : "+packTestName);
                                    txt_package_amount_cart.setText("MRP : ₹"+packagedata.list.get(0).orgAmount);
                                    txt_package_percentage_cart.setText(packagedata.list.get(0).percentage+" % Off");
                                    txt_package_discuount_cart.setText("Discount ₹"+packagedata.list.get(0).discount);
                                    txt_package_final_amount_cart.setText("MRP ₹"+packagedata.list.get(0).amount);
